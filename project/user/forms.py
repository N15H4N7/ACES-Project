...
class StudentRegisterForm(UserCreationForm):
	...
	class Meta(UserCreationForm.Meta):
		model 	= User
		fields 	= ['name', 'email', 'area_of_specialization', 'year_of_study', 'cgpa', 'city_of_residence', 'contact', 'password1', 'password2', 'Resume']
...
class StudentUpdateForm(forms.ModelForm):
	class Meta:
		...
		fields = ['name', 'area_of_specialization', 'year_of_study', 'cgpa', 'city_of_residence', 'contact']
